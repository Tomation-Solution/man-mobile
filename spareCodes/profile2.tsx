...
const EditProfile = ({ navigation }: any) => {
  ...
  const initialFormState = {
    membereducation: [
      {
        name_of_institution: memberEducation?.name_of_institution || "",
        degree: memberEducation?.degree || "",
        major: memberEducation?.major || "",
        speaking: memberEducation?.speaking || "",
        reading: memberEducation?.reading || "",
        language: memberEducation?.language || "",
        date: memberEducation?.date || "",
      },
    ],
    memberemploymenthistory: [
      {
        position_title: memberEmploymentHistory?.position_title || "",
        company_name: memberEmploymentHistory?.company_name || "",
        start_date: memberEmploymentHistory?.start_date || "",
        end_date: memberEmploymentHistory?.end_date || "",
        description: memberEmploymentHistory?.description || "",
      },
    ],
  };
  ...
  const formReducer = (state: any, action: any) => {
    switch (action.type) {
      ...
      case "addMemberEmploymentHistory":
        return {
          ...state,
          memberemploymenthistory: [
      ...
      case "updateMemberEducation":
        const updatedMemberEducation = [...state.membereducation];
        updatedMemberEducation[action.index] = action.value;
        return {
          ...state,
          membereducation: updatedMemberEducation,
        };

      case "updateMemberEmploymentHistory":
        const updatedMemberEmploymentHistory = [
          ...state.memberemploymenthistory,
        ];
        updatedMemberEmploymentHistory[action.index] = action.value;
        return {
          ...state,
          memberemploymenthistory: updatedMemberEmploymentHistory,
        };
      default:
        return state;
    }
  ...
  const handleEducationChange = (event: any, index: any) => {
    const {nam, value} = event.target;
    const updatedMemberEducation = [...formState.membereducation[index], {[nam]: value}];
    dispatch({
      type: "updateMemberEducation",
      index: index,
      value: updatedMemberEducation,
    });
