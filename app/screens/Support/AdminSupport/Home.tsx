...
const AdminSupport = ({navigation}:any) => {
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={{ fontSize:13,lineHeight:18,textAlign:'center', fontWeight:'400', }}>  Please fill the necessary information to get your support needs attended to as soon as posible</Text>
